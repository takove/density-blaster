      ...
      <section className="bg-gray-900 ">
              <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
                <div className="mx-auto max-w-screen-md sm:text-center">
                  <h2 className="mb-4 text-3xl tracking-tight font-extrabold text-white sm:text-4xl ">Sign up and we will get back to you</h2>
                  <p className="mx-auto mb-8 max-w-2xl font-light text-gray-200 md:mb-12 sm:text-xl ">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Architecto asperiores accusantium dignissimos nulla magnam quisquam ratione distinctio.</p>
                  <form action="#">
