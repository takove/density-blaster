      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          <h2 className="text-3xl font-medium tracking-tight text-white">
            Optimized postcard marketing tool.  
          </h2>
          <p className="mt-2 text-lg text-gray-400">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Quos iste consequatur pariatur vel nemo. Vero vel in maiores, ad, odio possimus commodi magnam cum doloribus voluptatibus laboriosam, explicabo quaerat labore?
          </p>
        </div>
      </Container>
