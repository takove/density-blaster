...
export function Hero() {
  return (
    <div id='hero' className="overflow-hidden py-20 sm:py-32 lg:pb-32 xl:pb-36">
      <Container>
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 lg:gap-y-20">
          <div className="relative z-10 mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Lorem ipsum dolor sit amet consectetur, adipisicing elit. Modi libero, sint possimus animi soluta ad nesciunt magni cum quisquam fuga! Qui expedita a nostrum velit omnis voluptatibus voluptate, quisquam perspiciatis.
            </p>
